...
//방 객체들을 배열에 넣음
var roomArray = [
    new Room("던전 입구","던전으로 들어가는 입구다.",1000,1001,0,0,0),
    new Room("던전 서쪽","던전 서쪽이다.",1001,1002,1000,0,0),
    new Room("던전 중앙","던전 중앙이다.",1002,0,1001,0,0)
]
...
window.onload = function(){
    ...
    displayRoomInfo(); //roomA. displayRoomInfo식으로 방 정보 출력한 것을 <<옆의 코드로 처리하도록 수정
